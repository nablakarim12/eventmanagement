...
<div class="space-y-6">
    ...
    @if($conferenceEvents->isNotEmpty())
    <div class="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg shadow-lg p-6 border border-purple-200">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Manage attendance and QR codes for upcoming/ongoing conferences</p>
            </div>
        </div>

            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-200">
                        <p class="text-xs text-gray-500 text-center mb-2">QR code not working?</p>
                        <a href="{{ route('dashboard.attendance.form', $registration->event) }}" 
                           class="block text-center bg-amber-100 hover:bg-amber-200 text-amber-800 text-sm font-semibold py-2 px-4 rounded-lg transition duration-200">

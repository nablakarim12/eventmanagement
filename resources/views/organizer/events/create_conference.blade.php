...
@section('title', 'Create Academic Conference Event')
@section('page-title', 'Create Academic Conference Event')
    ...
    <div class="max-w-6xl mx-auto">
        <form action="{{ route('organizer.events.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" placeholder="e.g., International Conference on AI & Machine Learning 2025" required>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="category_id" id="category_id" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" required>
                                @foreach($categories as $category)
                                    @if($category->name === 'Academic Conference')
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500 resize-none" placeholder="Describe your academic conference, topics, objectives, and expected outcomes..." required>{{ old('description') }}</textarea>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Conference Paper Theme: <span class="text-red-500">*</span></label>
                            <div id="categories-container" class="space-y-2">
                                <div class="category-item flex items-center gap-2">
                                    <input type="text" name="conference_categories[]" value="{{ old('conference_categories.0') }}" class="flex-1 px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" placeholder="e.g., Artificial Intelligence, Machine Learning" required>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="venue_name" value="{{ old('venue_name') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" placeholder="Enter venue/university name" required>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Venue Address: <span class="text-red-500">*</span></label>
                            <textarea name="venue_address" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500 resize-none" placeholder="Enter complete venue address" required>{{ old('venue_address') }}</textarea>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">City: <span class="text-red-500">*</span></label>
                                <input type="text" name="city" value="{{ old('city') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" placeholder="Enter city" required>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Country: <span class="text-red-500">*</span></label>
                                <input type="text" name="country" value="{{ old('country') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" placeholder="Enter country" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="max_participants" value="{{ old('max_participants') }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" placeholder="Enter maximum number of participants" required>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Registration Fee (RM): <span class="text-red-500">*</span></label>
                            <input type="number" name="registration_fee" value="{{ old('registration_fee', '0') }}" min="0" step="0.01" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-purple-500" required>
                ...
                <div class="mt-6">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Event Poster / Banner: <span class="text-red-500">*</span></label>
                    ...
                    <p id="image-error" class="text-xs text-red-600 mt-1 hidden">Please upload an event poster</p>
                </div>
            </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-purple-500 transition-colors delivery-mode-option">
                            <input type="radio" name="delivery_mode" value="face_to_face" class="mr-3" required>
                            <div>
                        ...
                        <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-purple-500 transition-colors delivery-mode-option">
                            <input type="radio" name="delivery_mode" value="online" class="mr-3" required>
                            <div>
                        ...
                        <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-purple-500 transition-colors delivery-mode-option">
                            <input type="radio" name="delivery_mode" value="hybrid" class="mr-3" required>
                            <div>
            ...
            <div id="f2f-section" class="mb-8" style="display: none;">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('f2f_reviewer_registration_deadline') }}" 
                        ...
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('f2f_paper_submission_deadline') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('f2f_acceptance_notification_date') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('f2f_payment_deadline') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
            ...
            <div id="online-section" class="mb-8" style="display: none;">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('online_reviewer_registration_deadline') }}" 
                        ...
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('online_paper_submission_deadline') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('online_review_deadline') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-green-500">
                            <p class="text-xs text-gray-500 mt-1">When reviewers must complete their evaluations</p>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('online_acceptance_notification_date') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-green-500">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" 
                                   ...
                                   value="{{ old('online_payment_deadline') }}" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-green-500">
                            <p class="text-xs text-gray-500 mt-1">Deadline for accepted participants to pay (after acceptance, before event)</p>
                        ...
                        <div>
                            ...
                            <input type="url" name="online_platform_url" id="online_platform_url" value="{{ old('online_platform_url') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-green-500" placeholder="e.g., https://zoom.us/j/123456789">
            ...
            <div class="mt-8 text-center">
                <button type="submit" name="status" value="published" class="bg-purple-600 hover:bg-purple-700 text-white px-12 py-3 rounded text-lg font-medium transition-colors">
                    <i class="fas fa-check-circle mr-2"></i>Create Conference Event
                </button>
            </div>
        </form>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Form submit handler to clean empty categories and validate image
    ...
    conferenceForm.addEventListener('submit', function(e) {
        ...
        if (!featuredImageInput.files || featuredImageInput.files.length === 0) {
            e.preventDefault();
            imageError.classList.remove('hidden');
            featuredImageInput.closest('label').classList.add('border-red-500');
            featuredImageInput.closest('label').scrollIntoView({ behavior: 'smooth', block: 'center' });
            return false;
        } else {
            imageError.classList.add('hidden');
            featuredImageInput.closest('label').classList.remove('border-red-500');
        }
    ...
    function validateF2FDates() {
        ...
        if (f2fReviewerReg.value && f2fPaperSubmission.value && f2fReview.value) {
            ...
            // Rule: Review deadline must be AFTER both reviewer registration and paper submission
            // (Reviewer registration and paper submission CAN be the same)
        ...
        // Event start date validation - must be after payment deadline (or acceptance if no payment)

...
@section('title', 'Create Innovation Competition Event')
@section('page-title', 'Create Innovation Competition Event')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 resize-none" placeholder="Describe your innovation competition event" required>{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <div id="categories-container" class="space-y-2">
                                <div class="category-item flex items-center gap-2">
                                    <input type="text" name="innovation_categories[]" value="{{ old('innovation_categories.0') }}" class="flex-1 px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" placeholder="e.g., High School, University" required>
                        ...
                        <div>
                            ...
                            <div id="themes-container" class="space-y-2">
                                <div class="theme-item flex items-center gap-2">
                                    <input type="text" name="innovation_theme[]" value="{{ old('innovation_theme.0') }}" class="flex-1 px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" placeholder="e.g., Artificial Intelligence" required>
                                    <button type="button" class="remove-theme hidden px-3 py-2 bg-red-500 text-white rounded hover:bg-red-600 transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                        </svg>
                                    </button>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="venue_address" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500 resize-none" placeholder="Enter complete venue address" required>{{ old('venue_address') }}</textarea>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">City: <span class="text-red-500">*</span></label>
                                <input type="text" name="city" value="{{ old('city') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" placeholder="Enter city" required>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Country: <span class="text-red-500">*</span></label>
                                <input type="text" name="country" value="{{ old('country') }}" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" placeholder="Enter country" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="max_participants" value="{{ old('max_participants') }}" min="1" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" placeholder="Enter maximum participants" required>
                        </div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors" id="drop-zone">
                                ...
                                <div id="preview-area" class="hidden">
                                    ...
                                    <p class="text-sm text-green-600 mt-2">
                                        <i class="fas fa-check-circle mr-1"></i>Image ready
                                    </p>
                                </div>
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors delivery-mode-option">
                            <input type="radio" name="delivery_mode" value="face_to_face" class="mr-3" required {{ old('delivery_mode') == 'face_to_face' ? 'checked' : '' }}>
                            <div>
                        ...
                        <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors delivery-mode-option">
                            <input type="radio" name="delivery_mode" value="online" class="mr-3" required {{ old('delivery_mode') == 'online' ? 'checked' : '' }}>
                            <div>
                        ...
                        <label class="relative flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition-colors delivery-mode-option">
                            <input type="radio" name="delivery_mode" value="hybrid" class="mr-3" required {{ old('delivery_mode') == 'hybrid' ? 'checked' : '' }}>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="f2f_registration_deadline" id="f2f_registration_deadline" 
                                       value="{{ old('f2f_registration_deadline') }}" 
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="f2f_jury_registration_deadline" id="f2f_jury_registration_deadline" 
                                       value="{{ old('f2f_jury_registration_deadline') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" required>
                                <p class="text-xs text-gray-500 mt-1">Must be today or later</p>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="f2f_submission_deadline" id="f2f_submission_deadline" 
                                       value="{{ old('f2f_submission_deadline') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="datetime-local" name="f2f_payment_deadline_new" id="f2f_payment_deadline" 
                                       value="{{ old('f2f_payment_deadline_new') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500" required>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="online_registration_deadline" id="online_registration_deadline" 
                                       value="{{ old('online_registration_deadline') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                <p class="text-xs text-gray-500 mt-1">Must be today or later</p>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="online_jury_registration_deadline_new" id="online_jury_registration_deadline" 
                                       value="{{ old('online_jury_registration_deadline_new') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                <p class="text-xs text-gray-500 mt-1">Must be today or later</p>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="online_submission_deadline" id="online_submission_deadline" 
                                       value="{{ old('online_submission_deadline') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                <p class="text-xs text-gray-500 mt-1">Must be after participant registration deadline</p>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="online_acceptance_notification_date_new" id="online_acceptance_notification_date" 
                                       value="{{ old('online_acceptance_notification_date_new') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                <p class="text-xs text-gray-500 mt-1">Must be after submission deadline</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="datetime-local" name="online_payment_deadline_new" id="online_payment_deadline" 
                                       value="{{ old('online_payment_deadline_new') }}" 
                                       class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-500">
                                <p class="text-xs text-gray-500 mt-1">Must be after all deadlines (original or extended if provided)</p>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="online_start_datetime" id="online_start_date" 
                                       value="{{ old('online_start_datetime') }}" 

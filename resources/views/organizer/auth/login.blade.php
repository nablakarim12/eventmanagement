...
<head>
    ...
    <title>Organizer Login - ConVex</title>
...
<body class="bg-gray-100 min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 items-center justify-center">
        <img src="{{ asset('assets/images/eolog.png') }}" alt="Event Organizer" class="w-full h-full object-cover">
    </div>

    <!-- Right Side - Login Form -->
    <div class="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white">
        <div class="max-w-md w-full space-y-8">
            ...
            <form class="mt-8 space-y-6" action="{{ route('organizer.login') }}" method="POST">
                @csrf
